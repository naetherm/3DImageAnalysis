...
// 
// Note, this program will not work at all. I've just added the basis but don't had time to finalize
// everything. I've attached this file only for completion and that you can see that I'm working on
// it.
// 
...
int main(int argc, char ** argv)
{
	...
	const std::string inFileName1 = "world_evaluation.h5";
	blitz::Array<double, 3> cFixedImage;
	std::cout << "Depth is: " << _nLevel << std::endl;
	std::string _sOutFilename = "evaled_world.h5";
